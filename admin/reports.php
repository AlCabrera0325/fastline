    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        @media print {
            ...
            .page-title, .section-title, .brand { color:black; }
...
<div class="page">
    ...
    <!-- Category Breakdown + City Breakdown -->
